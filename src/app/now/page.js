    ...
    <>
      ...
      <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-text-primary bg-bg my-14">
        <h1 className="text-3xl font-bold mb-4">
          🚀 What&apos;s New in TweakTail
        </h1>
        <p className="text-muted-foreground mb-8">
          Welcome to the evolution of TweakTail! We&apos;re constantly improving
          to make your experience even better. Here&apos;s what&apos;s new — and
          what&apos;s coming.
        </p>
        ...
        <p className="text-muted-foreground mb-4">
          We&apos;re just getting started. Here&apos;s a sneak peek at
          what&apos;s coming soon:
        </p>
        ...
        <div className="mt-12">
          ...
          <p className="text-text-primary mb-4">
            ...
            an improvement idea, or just want to say hi? Reach out — we&apos;re
            all ears.
          </p>
